...
function IconAthenaLogo({ className, ...props }: React.ComponentProps<'img'>) {
  const imageUrl = '/athena-logo-transparent.png'
  return (
    <img
      src={imageUrl}
      alt="OpenAI Logo"
...
function IconAthenaLogoBlackBackground({ className, ...props }: React.ComponentProps<'img'>) {
  const imageUrl = '/athena-logo.png'
  return (
    <img
      src={imageUrl}
      alt="OpenAI Logo"
...
function IconAthenaNameLogo({ className, ...props }: React.ComponentProps<'img'>) {
  const imageUrl = '/athena-name-logo-transparent.png'
  return (
    <img
      src={imageUrl}
      alt="OpenAI Logo"
